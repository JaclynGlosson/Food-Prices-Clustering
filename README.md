...
The goal of this assignment was to perform single linkage and k-means clustering on food price data for different U.S. cities in the 1970s. As expected, single linkage clustering did not result in a great clustering fit. Because k-means utilizes euclidean distance, standardization was necessary to obtain the best clustering fit, as some of our food prices were three times the price of other food prices. PCA was utlized to represent all clusters graphically. The final standardized K-means clustering resulted in three clusters: cheap cities, expensive cities, and average cities.
...
* [Explore the Data](https://github.com/JaclynGlosson/Food-Prices-Clustering#explore-the-data)
* [Compute a distance matrix and run hclust()](https://github.com/JaclynGlosson/Food-Prices-Clustering#compute-a-distance-matrix-and-run-hclust)
* [Plot Dendrogram](https://github.com/JaclynGlosson/Food-Prices-Clustering#plot-dendrogram)
* [Choose number of clusters](https://github.com/JaclynGlosson/Food-Prices-Clustering#choose-number-of-clusters)
* [Get cluster centers](https://github.com/JaclynGlosson/Food-Prices-Clustering#get-cluster-centers)
* [Calculate sum of total sum of squares](https://github.com/JaclynGlosson/Food-Prices-Clustering#calculate-sum-of-total-sum-of-squares)
* [Unstandardized K-Means Clustering](https://github.com/JaclynGlosson/Food-Prices-Clustering#unstandardized-k-means-clustering)
* [Run K-means and analyze clusters](https://github.com/JaclynGlosson/Food-Prices-Clustering#run-k-means-and-analyze-clusters)
* [Plot clusters](https://github.com/JaclynGlosson/Food-Prices-Clustering#plot-clusters)
* [Choose K and plot total ss](https://github.com/JaclynGlosson/Food-Prices-Clustering#choose-k-and-plot-total-ss)
* [Interpretation](https://github.com/JaclynGlosson/Food-Prices-Clustering#interpretation)
* [Plot clusters with PCA](https://github.com/JaclynGlosson/Food-Prices-Clustering#plot-clusters-with-pca)
* [Standardized K Means Clustering](https://github.com/JaclynGlosson/Food-Prices-Clustering#standardized-k-means-clustering)
* [Run k-means to analyze clusters](https://github.com/JaclynGlosson/Food-Prices-Clustering#run-k-means-to-analyze-clusters)
* [Plot clusters](https://github.com/JaclynGlosson/Food-Prices-Clustering#plot-clusters-1)
* [Interpretation](https://github.com/JaclynGlosson/Food-Prices-Clustering#interpretation-1)
* [Plot clusters with PCA](https://github.com/JaclynGlosson/Food-Prices-Clustering#plot-clusters-with-pca-1)
